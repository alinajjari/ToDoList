    ...
    <div className="grid grid-cols-12 gap-x-6">
      <div className="col-span-4 bg-slate-800 bg-opacity-40 rounded-xl p-6 max-h-[90vh] overflow-y-auto relative">
        ...
        <form className="text-white">
          <input className="w-full bg-slate-900 rounded-full p-3 mb-3 placeholder:text-xs focus:outline-none" type="text" placeholder="Add Title..." name="" id="" />
          ...
          <textarea className="w-full bg-slate-900 rounded-xl p-3 mb-3 placeholder:text-xs focus:outline-none h-28" placeholder="Add Description..." name="" id=""></textarea>
          <button className="bg-orange-700 w-full p-3 text-center rounded-full cursor-pointer" type="submit">Add Task...</button>
        </form>
      </div>
