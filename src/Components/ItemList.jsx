...
function ItemList(props, {btnDelete}) {
  return (
    ...
    <div className="basis-1/5 flex justify-end items-center gap-x-3">
      <button onClick={()=> btnDelete(props.task.id)} className="text-stone-400">
    ...
    <div className="text-gray-500">{props.task.desc}</div>
